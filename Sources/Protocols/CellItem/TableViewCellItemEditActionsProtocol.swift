...
public protocol TableViewCellItemEditActionsProtocol {
    ...
    func canCommit(_ editingStyle: EditingStyle, in tableView: UITableView) -> Bool
    ...
    func editingStyle(in tableView: UITableView, at indexPath: IndexPath) -> EditingStyle
...
public extension TableViewCellItemEditActionsProtocol {
    ...
    func canCommit(_ editingStyle: EditingStyle, in tableView: UITableView) -> Bool { return false }
    func editActions(in tableView: UITableView, at indexPath: IndexPath) -> [UITableViewRowAction]? { return nil }
    
    func editingStyle(in tableView: UITableView, at indexPath: IndexPath) -> EditingStyle { return .delete }
