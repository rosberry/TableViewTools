...
public protocol TableViewCellItemProtocol: AnyObject {
    ...
    /// The reuse identifier specified in Storyboard.
    var storyboardPrototypeTableViewCellReuseIdentifier: String? { get }
    /// The nib for registration in `UITableView`.
    var registeredTableViewCellNib: UINib? { get }
    /// The class for registration in `UITableView`.
    var tableViewCellClassForRegistration: AnyClass? { get }
